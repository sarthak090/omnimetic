...
export default function Nav() {
  return (
    <nav className="flex md:px-12  justify-between py-4 bg-gray-900 my-4 gap-2  text-white">
      <div className="flex gap-1 items-center text-sm md:text-xl">
        <svg
          width="11"
          height="18"
          viewBox="0 0 11 18"
      ...
      <div>
        <div className="flex  md:flex-row justify-between gap-2">
          <div className="text-sm md:text-xl border-r-2 pr-2 ">Share</div>
